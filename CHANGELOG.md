...
### Fixed
- `Archive::extract()` and `Archive::extractMembers()` now explicitly set/reset adapter password
  on every call to prevent password state leakage between operations.

### Changed
- README requirements now explicitly state that either `7za` or `7z` binaries are supported.
...
[Unreleased]: https://github.com/victor78/ZippyExt/compare/v1.0.3...HEAD
[1.0.3]: https://github.com/victor78/ZippyExt/compare/v1.0.2...v1.0.3
